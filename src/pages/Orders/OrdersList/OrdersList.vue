    ...
    <div style="margin-top: 15px;">
        <form  class="el-form el-form--inline">
            <div class="el-form-item el-form-item--small">
                ...
                <div class="el-form-item__content">
                    <div  class="input-width el-input el-input--small">
                        <input type="text" autocomplete="off" placeholder="订单编号" class="el-input__inner">
                    </div>
                </div>
            </div>
            <!-- 收货人 -->
            <div class="el-form-item el-form-item--small">
                ...
                <div class="el-form-item__content">
                    <div data-v-ebcc336a="" class="input-width el-input el-input--small">
                        <input type="text" autocomplete="off" placeholder="收货人姓名/手机号码" class="el-input__inner">
                    </div>
                </div>
            </div>
            <!-- 提交时间 -->
            <div data-v-ebcc336a="" class="el-form-item el-form-item--small">
                ...
                <div class="el-form-item__content">
                    <div data-v-ebcc336a="" class="el-date-editor input-width el-input el-input--small el-input--prefix el-input--suffix el-date-editor--date">
                        <input type="text" autocomplete="off" name="" placeholder="请选择时间" class="el-input__inner">
            ...
            <div data-v-ebcc336a="" class="el-form-item el-form-item--small">
                ...
                <div class="el-form-item__content">
                    <div data-v-ebcc336a="" class="el-select input-width el-select--small">
                        ...
                        <div class="el-select-dropdown el-popper" style="display: none; min-width: 203px;">
